...
function MUISwitch(props) {
  ...
  return (
    <SwitchRoot className={clsx(stateClasses)} onChange={()=>{ props.setTheme(checked); }}>
      <SwitchTrack>
...
export default function UseSwitchesCustom({currentTheme, setTheme}) {
  return <MUISwitch currentTheme={currentTheme} setTheme={setTheme} />;
}